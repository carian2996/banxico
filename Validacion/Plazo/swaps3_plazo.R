...
swaps3_plazo <- function(){
      
      # SALIDA
      # cuadro_swaps3_[fecha].dbf - Archivo tipo .dbf con los resultados
      ...
      nueva_fecha <- apply(data[, c("FE_ORI_RE", "FE_ORI_EN")], 1, max)
      ...
      write.dbf(data, paste("swaps3_plazo_", format(Sys.Date()[1], "%d_%m_%Y"), ".dbf", sep=""))
