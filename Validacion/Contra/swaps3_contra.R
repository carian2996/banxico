...
swaps3_contra <- function(){
      # ===== SWAPS 3 =====
      
      # SALIDA
      # swaps3_[fecha].dbf - Archivo tipo .dbf con los resultados
      ...
      data <- data[complete.cases(data$FE_CON_OPE, data$C_IMP_BA_R, data$MDA_IMP_RE, 
                                  ...
                                  data$C_IMP_EN_D, data$CONT, data$TIP_CONT), ]
      ...
      write.dbf(data, paste("swaps3_contra_", format(Sys.Date()[1], "%d_%m_%Y"), ".dbf", sep=""))
